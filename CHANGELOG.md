...
### Added
- Integrated BWT and Deflate (LZ77+Huffman) strategies into OptimizedCompressor.
- Updated ParallelCompressor factory to support OptimizedCompressor for multithreaded runs.
- Extended benchmark suite with new results reflecting improved compression ratios.

### Fixed
- Resolved crash when running multi-threaded OptimizedCompressor benchmarks.
